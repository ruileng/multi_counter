...
class LegRaisesCounter:
    """
    A counter for the 'LegRaisesCounter' action, generated from a standardized template.
    ...
    def __init__(self):
        ...
        self.landmark = mp.solutions.pose.PoseLandmark.RIGHT_KNEE.value
        self.aux_landmark = None
        ...
        self.validation_landmarks = [
            ...
            mp.solutions.pose.PoseLandmark.RIGHT_ANCLE.value,
