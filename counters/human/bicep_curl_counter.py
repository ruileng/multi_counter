...
class BicepCurlCounter:
    """
    A counter for the 'BicepCurlCounter' action, generated from a standardized template.
    ...
    def __init__(self):
        ...
        self.landmark = mp.solutions.pose.PoseLandmark.LEFT_ELBOW.value
        self.aux_landmark = mp.solutions.pose.PoseLandmark.RIGHT_ELBOW.value
