...
class CalfRaisesCounter:
    """
    A counter for the 'CalfRaisesCounter' action, generated from a standardized template.
    ...
    def __init__(self):
        ...
        self.landmark = mp.solutions.pose.PoseLandmark.RIGHT_ANKLE.value
        self.aux_landmark = mp.solutions.pose.PoseLandmark.LEFT_ANKLE.value
