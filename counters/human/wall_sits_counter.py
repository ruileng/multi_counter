...
class WallSitsCounter:
    """
    A counter for the 'WallSitsCounter' action, generated from a standardized template.
    ...
    def __init__(self):
        ...
        self.landmark = mp.solutions.pose.PoseLandmark.LEFT_KNEE.value
