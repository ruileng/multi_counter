...
class MountainClimbersCounter:
    """
    A counter for the 'MountainClimbersCounter' action, generated from a standardized template.
    ...
    def __init__(self):
        ...
        self.aux_landmark = mp.solutions.pose.PoseLandmark.RIGHT_HIP.value
