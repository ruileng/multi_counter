...
class JumpingJackCounter:
    """
    A counter for the 'JumpingJackCounter' action, generated from a standardized template.
    ...
    def __init__(self):
        ...
        self.logic_type = "jumping_jack"
        self.direction = "up-first"
        self.landmark = mp.solutions.pose.PoseLandmark.NOSE.value
        self.aux_landmark = mp.solutions.pose.PoseLandmark.LEFT_SHOULDER.value
