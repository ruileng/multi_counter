...
class SquatCounter:
    """
    A counter for the 'SquatCounter' action, generated from a standardized template.
    ...
    def __init__(self):
        ...
        self.landmark = mp.solutions.pose.PoseLandmark.RIGHT_HIP.value
        self.aux_landmark = mp.solutions.pose.PoseLandmark.LEFT_HIP.value
