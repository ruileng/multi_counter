...
class HighKneeLiftCounter:
    """
    A counter for the 'HighKneeLiftCounter' action, generated from a standardized template.
    ...
    def __init__(self):
        ...
        self.aux_landmark = mp.solutions.pose.PoseLandmark.LEFT_KNEE.value
