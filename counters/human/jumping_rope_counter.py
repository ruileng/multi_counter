...
class JumpingRopeCounter:
    """
    A counter for the 'JumpingRopeCounter' action, generated from a standardized template.
    ...
    def __init__(self):
        ...
        self.landmark = mp.solutions.pose.PoseLandmark.LEFT_HEEL.value
        self.aux_landmark = None
        self.min_visibility = 0.08
        self.threshold = 0.1
