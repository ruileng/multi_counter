...
class BurpeesCounter:
    """
    A counter for the 'BurpeesCounter' action, generated from a standardized template.
    ...
    def __init__(self):
        ...
        self.landmark = mp.solutions.pose.PoseLandmark.LEFT_HIP.value
        self.aux_landmark = mp.solutions.pose.PoseLandmark.RIGHT_KNEE.value
        ...
        self.validation_landmarks = [
            ...
            mp.solutions.pose.PoseLandmark.LEFT_ANCLE.value,
        ]
